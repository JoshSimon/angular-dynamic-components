...
export class AppComponent {
  ...
  dynamicComponents: DynamicComponent[]; // array of components that will created dynamically
  ...
  ngAfterViewInit() {
    this.loadMyDynamicComponent(this.dynamicComponents[0]); //loading the default first item out of the "dynamicComponents" array   
    
//!!!    this.arrayOfAllExistingComponents.push({ "name": this.dynamicComponents[0].data.name, "id": this.createAnIndividualId(this.dynamicComponents[0].data.name), "description": this.dynamicComponents[0].data.name })
  };
  ...
  //   for (let i of this.dynamicComponents) {
  //     if (name == this.dynamicComponents[i]) {
  //       this.loadMyDynamicComponent(this.dynamicComponents[i]);
  //       this.arrayOfAllExistingComponents.push({ "name": name, "id": this.createAnIndividualId(name), "description": howTheUserCallsIt })
  //     }
  //   }
  // };
  ...
  onClick(name:string) {
    ...
    case this.mocks[0].name : {
      ...
      case this.mocks[1].name : {
       this.loadMyDynamicComponent(this.dynamicComponents[1]);
       break;
    }
    }
  }
